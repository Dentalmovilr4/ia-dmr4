...
// Configuración de cliente con Passphrase para KuCoin
...
async function loop() {
  try {
     ...
     * Para activar, quita las barras '//' de la línea de abajo.
    ...
    if (error.message.includes('insufficient')) {
        console.error("👉 Error: Saldo insuficiente en la Trading Account de KuCoin.");
    }
  }
}

console.log(`⚙️ IA-DMR4: Execution Algo (${MODE}) activo para ${SYMBOL} en ${process.env.EXCHANGE}...`);
